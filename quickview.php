						 ...
						 <div class="row">
							 ...
							 <div class="content-product-right col-sm-6 col-xs-12">
								 ...
								 <!-- <div class="box-review form-group">
									 ...
									 <a class="reviews_button" href="quickview.php" onclick="$('a[href=\'#tab-review\']').trigger('click'); return false;">0 reviews </a>	
								 </div> -->

								 <div class="product-label form-group">
									 <div class="product_page_price price" itemprop="offerDetails" itemscope="" itemtype="http://data-vocabulary.org/Offer">
										 <span class="price-new" itemprop="price">$<?php echo $result['price']-$result['price']*0.15;?> </span>
								 ...
								 <div class="product-box-desc">
									 <div class="inner-box-desc">
										 <div class="price-tax"><span>Ex Tax (5%):</span> $<?php echo $result['price']*0.05; ?> </div>
