			...
			<div class="product-item-container">
				<div class="left-block">
					<div class="product-image-container second_img ">
						<img  src="admin/<?php echo $result['image'];?>"  title="<?php echo $result['product_name'];?>" class="img-responsive" />
						<img  src="admin/<?php echo $result['image'];?>"  title="<?php echo $result['product_name'];?>" class="img_0 img-responsive" />
					</div>
					<!--Sale Label-->
				...
				<div class="right-block">
					<div class="caption">
						...
						<div class="description item-desc hidden">
							<p><?php echo $fm->validation($fm->textShorten($result['body'], 50)); ?></p>
						</div>
					</div>
